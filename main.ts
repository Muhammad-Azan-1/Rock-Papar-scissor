...
let msg = document.querySelector("#msg") as HTMLInputElement;  // confirming type that msg is the element contains html element, to use related mehtods like innerText etc
let yourScorePara = document.querySelector("#your-score") as HTMLInputElement;
let computerScorePara = document.querySelector("#computer-score") as HTMLInputElement;
...
function showWinner(userWin:boolean, yourChoice:string , computerChoice:string){
